...
\Entry
Android (Framework, Platform API, and App Devleopment), Bytecode Instrumentation Tools such as Soot, Firebase
...
\Gap
\BulletItem
\textbf{Gesto} [EICS `19, PAHCI] is a system that enables task automation for Android apps using gestures 
...
\textit{Link: \href{http://beyondthegeek.com/portfolio/gesto-eics-19/}
...
\textit{Link: \href{http://reptor.cse.buffalo.edu/}{http://reptor.cse.buffalo.edu/}}
\hfill

\Gap
\BulletItem
\textbf{Mimic} [Under submission] is an automated UI compatibility testing system for Android apps. 
...
and \textit{Journal Proceedings of the ACM on Human-Computer Interaction \textbf{(PAHCI)}}
, \DatestampYM{2019}{06}.}
...
``Mimic: UI Compatibility Testing System for Android Apps'' submitted to
\textit{Proceedings of the 41th International Conference on Software Engineering \textbf{(ICSE)}
\DatestampYM{2019}.}
...
``Reptor: Enabling API Virtualization on Android for Platform Openness'' submitted to 
\textit{ACM Transactions on Software Engineering and Methodology \textbf{(TOSEM)}
\DatestampYM{2018}}}.}
