...
\Entry
Mobile systems, UI automation, and automated testing system.
...
\Entry
Android Platform API, Soot API, Java, Python, C++, and Linux OS
\BigGap
...
and voice commands. Using our system, a user can record a UI action sequence for an app, 
...
``Gesto: Mapping UI Events to Gestures and Voice''
forthcoming in
\textit{Journal Proceedings of the ACM on Human-Computer Interaction - EICS
\DatestampY{2019}.}
...
graduate career at this University. 
\end{Detail}
...
\Gap
\BulletItem
Dean's List, Fall 2012, University at Buffalo
\hfill
\DatestampY{2012}
